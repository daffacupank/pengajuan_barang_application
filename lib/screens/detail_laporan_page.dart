...
class _DetailLaporanPageState extends State<DetailLaporanPage> {
  ...
  Widget _detail(LaporanModel l) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height: 16),
      AppCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Keterangan Admin', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: AppColors.primaryDark)),
        const SizedBox(height: 12),
        Container(
          ...
          child: Text(
            l.keteranganAdmin.trim().isEmpty ? 'Belum ada keterangan dari admin.' : l.keteranganAdmin,
            style: const TextStyle(color: AppColors.text, height: 1.5, fontWeight: FontWeight.w700),
          ),
        ),
      ])),
      const SizedBox(height: 16),
